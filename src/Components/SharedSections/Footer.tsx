  ...
  return (
    <footer className="site-footer">
      ...
      <style>{`
        ...
        .footer-column a { display: flex; width: max-content; align-items: center; gap: 7px; color: #000; font-size: 16px; font-weight: 500; line-height: 1.25; }
        .footer-column a:hover { color: #555; }
        ...
        .footer-divider { border-top: 1px solid #e5e5e5; }
        ...
        .footer-partner > p { display: flex; margin: 11px 0 0; align-items: center; gap: 10px; color: #000; font-size: 15px; font-weight: 500; white-space: nowrap; }
